...
public enum ProviderIDs {
    ...
    public static let systemCalendar: ProviderID = "system.calendar"
    public static let systemLocation: ProviderID = "system.location"
    public static let systemFocus: ProviderID = "system.focus"
}
